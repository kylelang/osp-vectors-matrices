...
::: {.callout-note}
You'll perform arithmetic and logical operations on vectors, and you'll
need to be able to explain *why* R's recycling rule produces the results it does. The recycling concept
in particular is worth understanding, not just executing. It comes up again with matrices and data frames later in
this module and the next.
:::
